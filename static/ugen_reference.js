...
'blsaw': { 'Args': [ 'freq', 'amp' ], 'Outputs': 1 , 'Link': 'blsaw' , 'Description': 'Band-limited sawtooth oscillator'},
'blsquare': { 'Args': [ 'freq', 'amp', 'width (0.5)' ], 'Outputs': 1 , 'Link': 'blsquare' , 'Description': 'Band-limited square oscillator with pulse-width'},
'bltriangle': { 'Args': [ 'freq', 'amp' ], 'Outputs': 1 , 'Link': 'bltriangle' , 'Description': 'Band-limited triangle oscillator'},
...
'saw': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Description': 'Band-limited sawtooth oscillator. (alias of blsaw)'},
...
'square': { 'Args': [ 'freq (f) width (f) amp (f)' ], 'Outputs': 1 , 'Description': 'Band-limited square oscillator with pulse-width (alias of blsquare)'},
...
'tri': { 'Args': [ 'freq (f) amp (f)' ], 'Outputs': 1 , 'Description': 'Band-limited triangle oscillator (alias of bltriangle)'},
'triangle': { 'Args': [ 'freq (f) amp (f)' ], 'Outputs': 1 , 'Description': 'Band-limited triangle oscillator (alias of bltriangle)'},
