ugen_ref = {
'%': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'mod' , 'Description': 'Performs modulus operation.'},
'&': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'and' , 'Description': 'Performs logical "and" operation.'},
'/': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'div' , 'Description': 'Performs division.'},
'abs': { 'Args': [ 'v1' ], 'Outputs': 1 , 'Link': 'abs' , 'Description': 'Performs absolute value.'},
'add': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'add' , 'Description': 'Performs addition.'},
'adsr': { 'Args': [ 'gate', 'attack', 'decay', 'sustain', 'release' ], 'Outputs': 1 , 'Link': 'adsr' , 'Description': 'Analogue modelled ADSR generator'},
'allpass': { 'Args': [ 'revtime', 'looptime' ], 'Outputs': 1 , 'Link': 'allpass' , 'Description': 'allpass filter'},
'ampdb': { 'Args': [ 'db' ], 'Outputs': 1 , 'Link': 'ampdb' , 'Description': 'converts decibels to amplitude'},
'atone': { 'Args': [ 'cutoff' ], 'Outputs': 1 , 'Link': 'atone' , 'Description': 'simple one-pole high pass filter'},
'autowah': { 'Args': [ 'level', 'wah', 'mix' ], 'Outputs': 1 , 'Link': 'autowah' , 'Description': 'autowah'},
'bal': { 'Args': [ 'reference', 'in' ], 'Outputs': 1 , 'Link': 'bal' , 'Description': 'match the input\'s amplitude the reference\'s amplitude'},
'biscale': { 'Args': [ 'v1', 'min', 'max' ], 'Outputs': 1 , 'Link': 'biscale' , 'Description': 'Scales from bipolar [-1, 1] to [min, max].'},
'bitcrush': { 'Args': [ 'bitdepth (8)', 'samplerate (10000)' ], 'Outputs': 1 , 'Link': 'bitcrush' , 'Description': 'bitcrusher. bitdepth: 1 - 16'},
'blsaw': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Link': 'blsaw' , 'Description': 'Band-limited sawtooth oscillator (aliases: [saw])'},
'blsquare': { 'Args': [ 'freq (f)', 'amp (f)', 'width (f)(0.5)' ], 'Outputs': 1 , 'Link': 'blsquare' , 'Description': 'Band-limited square oscillator with pulse-width (aliases: [square])'},
'bltriangle': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Link': 'bltriangle' , 'Description': 'Band-limited triangle oscillator (aliases: [tri, triangle])'},
'bpm2dur': { 'Args': [ 'bpm' ], 'Outputs': 1 , 'Link': 'bpm2dur' , 'Description': 'convert bpm to duration (seconds)'},
'bpm2rate': { 'Args': [ 'bpm' ], 'Outputs': 1 , 'Link': 'bpm2rate' , 'Description': 'convert bpm to rate (Hertz)'},
'branch': { 'Args': [ 'gate', 'sig1', 'sig2' ], 'Outputs': 1 , 'Link': 'branch' , 'Description': 'returns signal based on state of gate (0 = sig1, 1 = sig2)'},
'brown': { 'Args': [  ], 'Outputs': 1 , 'Description': 'Brownian noise generator'},
'butbp': { 'Args': [ 'in', 'freq', 'bw' ], 'Outputs': 1 , 'Link': 'butbp' , 'Description': 'butterworth bandpass filter'},
'butbr': { 'Args': [ 'in', 'freq', 'bw' ], 'Outputs': 1 , 'Link': 'butbr' , 'Description': 'butterworth band reject filter'},
'buthp': { 'Args': [ 'in', 'cutoff' ], 'Outputs': 1 , 'Link': 'buthp' , 'Description': 'Butterworth highpass filter'},
'butlp': { 'Args': [ 'in', 'cutoff' ], 'Outputs': 1 , 'Link': 'butlp' , 'Description': 'Butterworth lowpass filter'},
'c': { 'Args': [ 'init value' ], 'Outputs': 1 , 'Link': 'c' , 'Description': 'Constant generator, used for feedback loops.'},
'cf': { 'Args': [ 'sig1', 'sig2', 'pos' ], 'Outputs': 1 , 'Link': 'crossfade' , 'Description': 'crossfade two signals'},
'changed': { 'Args': [ 'sig' ], 'Outputs': 1 , 'Link': 'changed' , 'Description': 'Returns a trigger if the input changes'},
'clip': { 'Args': [ 'in', 'limit (1)' ], 'Outputs': 1 , 'Link': 'clip' , 'Description': 'clip limiter / distortion'},
'clock': { 'Args': [ 'trig', 'bpm', 'subdiv' ], 'Outputs': 1 , 'Link': 'clock' , 'Description': 'Clock with subdivisions and triggerable reset'},
'comb': { 'Args': [ 'in', 'rev time', 'loop time' ], 'Outputs': 1 , 'Link': 'comb' , 'Description': 'comb filter'},
'conv': { 'Args': [ 'in', 'delay', 'ftbl impulse response' ], 'Outputs': 1 , 'Link': 'conv' , 'Description': 'partitioned convolution'},
'count': { 'Args': [ 'trig', 'max', 'mode' ], 'Outputs': 1 , 'Link': 'count' , 'Description': 'clock counter. mode: 0 = loop, 1 = one-shot'},
'crossfade': { 'Args': [ 'sig1', 'sig2', 'pos' ], 'Outputs': 1 , 'Link': 'crossfade' , 'Description': 'crossfade two signals'},
'dcblk': { 'Args': [ 'f' ], 'Outputs': 1 , 'Link': 'dcblk' , 'Description': 'dc block filter.'},
'delay': { 'Args': [ 'in', 'feedback', 'deltime' ], 'Outputs': 1 , 'Link': 'delay' , 'Description': 'feedback delay'},
'diode': { 'Args': [ 'in', 'cutoff', 'res' ], 'Outputs': 1 , 'Link': 'diode' , 'Description': 'Diode ladder filter'},
'dist': { 'Args': [ 'pregain (1)', 'gain (1)', 'shape1 (0)', 'shape2 (0)' ], 'Outputs': 1 , 'Link': 'dist' , 'Description': 'Distortion'},
'div': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'div' , 'Description': 'Performs division.'},
'dmetro': { 'Args': [ 'time' ], 'Outputs': 1 , 'Link': 'dmetro' , 'Description': 'Metronome using time instead of frequency'},
'drip': { 'Args': [ 'trig', 'num_tubes', 'amp', 'shake_max', 'main freq', 'res freq 1', 'res freq 2', 'decay' ], 'Outputs': 1 , 'Link': 'drip' , 'Description': 'dripwater physical model'},
'drop': { 'Args': [ 'f' ], 'Outputs': 1 , 'Link': 'drop' , 'Description': 'Removes the last item on the stack.'},
'dtrig': { 'Args': [ 'trig', 'loop', 'delay', 'scale', 'tbl' ], 'Outputs': 1 , 'Link': 'dtrig' , 'Description': 'delta trig. loop = 1 will loop the sequence'},
'dup': { 'Args': [ 'f' ], 'Outputs': 2 , 'Link': '/operations' , 'Description': 'Duplicates last item on the stack.'},
'dup2': { 'Args': [ 'f', 'f' ], 'Outputs': 4 , 'Link': 'dup2' , 'Description': 'Duplicates the two last item on the stack.'},
'dur': { 'Args': [  ], 'Outputs': 1 , 'Description': 'returns duration of sporth patch (in seconds)'},
'durs': { 'Args': [ '(none)' ], 'Outputs': 1 , 'Description': 'returns duration of sporth patch (in samples)'},
'dust': { 'Args': [ 'amp', 'density', 'bipolar' ], 'Outputs': 1 , 'Description': 'dust. bipolar = 1 unipolar = 0'},
'edo': { 'Args': [ 'pitch_num (f)', 'edo (f)' ], 'Outputs': 1 , 'Description': 'Return a pitch that divides an octave into `edo` steps. `pitch_num` set to 0 always equals Middle-C, ~261.6255 HZ. Negative `pitch_num` will go below middle-C.'},
'eq': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Description': 'conditional equals'},
'eqfil': { 'Args': [ 'in(f) freq', 'bw', 'gain' ], 'Outputs': 1 , 'Description': 'eq filter'},
'eval': { 'Args': [ 'sporth instructions (s)' ], 'Outputs': 1 , 'Description': 'Evaluates sporth string to stack'},
...
'fc': { 'Args': [ 'tbl (s)' ], 'Outputs': 1 , 'Description': 'close a dynamically loaded ugen (call this once at the end)'},
'fe': { 'Args': [ 'tbl (s)' ], 'Outputs': 1 , 'Description': 'execute a dynamically loaded ugen'},
...
'ftsum': { 'Args': [ 'start (f)', 'end (f)', 'tbl (s)' ], 'Outputs': 1 , 'Description': 'sum a range of ftable values (inclusive). built for polysporth.'},
...
'gen_vals': { 'Args': [ 'name', 'args' ], 'Outputs': 1 , 'Link': '/prop' , 'Description': 'Generates an ftable from a space delimited set of values.'},
...
'limit': { 'Args': [ 'in (f)', 'min (f)', 'max (f)' ], 'Outputs': 1 , 'Description': 'limit signal within range given'},
...
'mul': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'mul' , 'Description': 'Performs multiplication.'},
'ne': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Description': 'conditional not-equal to'},
'noise': { 'Args': [ 'gain' ], 'Outputs': 1 , 'Description': 'White noise generator.'},
'nsmp': { 'Args': [ 'trig (f)', 'index (f)', 'sr (f)', 'ini (s)', 'wav (s)' ], 'Outputs': 1 , 'Description': 'Nanosamp sampler. See soundpipe docs.'},
'osc': { 'Args': [ 'freq', 'amp', 'phase', 'ft name' ], 'Outputs': 1 , 'Link': 'osc' , 'Description': 'Wavetable lookup oscillator'},
'oscmorph2': { 'Args': [ 'freq', 'amp', 'wtpos', 'phase', 'ft1', 'ft2' ], 'Outputs': 1 , 'Link': 'oscmorph2' , 'Description': '2-table morphing oscillator'},
'oscmorph4': { 'Args': [ 'freq', 'amp', 'wtpos', 'phase', 'ft1', 'ft2', 'ft3', 'ft4' ], 'Outputs': 1 , 'Link': 'oscmorph4' , 'Description': '4-table morphing oscillator'},
...
'paulstretch': { 'Args': [ 'stretch (F)', 'window size (F)', 'tbl (s)' ], 'Outputs': 1 , 'Description': 'Paulstretch algorithm'},
...
'posc3': { 'Args': [ 'freq', 'amp', 'ftable' ], 'Outputs': 1 , 'Link': 'posc3' , 'Description': 'high-precision oscillator with cubic interpolation'},
'print': { 'Args': [ 'val (f/s) label (s)' ], 'Outputs': 1 , 'Description': 'prints values to terminal'},
'prop': { 'Args': [ 'bpm', 'prop string' ], 'Outputs': 1 , 'Link': '/prop' , 'Description': 'Parses prop code to produce a set of triggers'},
'pset': { 'Args': [ 'val', 'num' ], 'Outputs': 1 , 'Link': '/pregisters' , 'Description': 'p register set'},
'pshift': { 'Args': [ 'in', 'shift (semitones)', 'window size (samps)', 'xfade (samps)' ], 'Outputs': 1 , 'Description': 'pitch shifter'},
'pst': { 'Args': [ 'tog', 'id', 'ftname' ], 'Outputs': 1 , 'Description': 'toggle a polysporth sporthlet'},
...
'rms': { 'Args': [ 'signal (f)' ], 'Outputs': 1 , 'Description': 'Determines the root-mean-square amplitude of an audio signal'},
'rot': { 'Args': [ 'f', 'f', 'f' ], 'Outputs': 3 , 'Link': '/operations' , 'Description': 'Stack rotate. s: 1 2 3 -> 2 3 1'},
...
'saw': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Link': 'blsaw' , 'AliasOf': 'blsaw' , 'Description': 'Band-limited sawtooth oscillator (alias of: blsaw)'},
'say': { 'Args': [ 'val (f/s)' ], 'Outputs': 1 , 'Description': 'prints string value to terminal'},
'scale': { 'Args': [ 'v1', 'min', 'max' ], 'Outputs': 1 , 'Description': 'Scales from unipolar [0, 1] to [min, max].'},
'scrambler': { 'Args': [ 'name (s)', 'name (s)' ], 'Outputs': 1 , 'Description': 'Scramble signals between two ftables'},
...
'square': { 'Args': [ 'freq (f)', 'amp (f)', 'width (f)(0.5)' ], 'Outputs': 1 , 'Link': 'blsquare' , 'AliasOf': 'blsquare' , 'Description': 'Band-limited square oscillator with pulse-width (alias of: blsquare)'},
...
'sub': { 'Args': [ 'v1', 'v2' ], 'Outputs': 1 , 'Link': 'sub' , 'Description': 'Performs subtraction.'},
'swap': { 'Args': [ 'f', 'f' ], 'Outputs': 2 , 'Link': '/operations' , 'Description': 'Swaps last two items on the stack.'},
'switch': { 'Args': [ 'trig', 'sig1', 'sig2' ], 'Outputs': 1 , 'Link': 'switch' , 'Description': 'toggle between two signals'},
'tabread': { 'Args': [ 'index', 'scaled (1: yes, 0: no)', 'offset', 'wrap', 'ftname' ], 'Outputs': 1 , 'Link': 'tabread' , 'Description': 'read from table with interpolation'},
...
'tblrec': { 'Args': [ 'in', 'tbl name' ], 'Outputs': 1 , 'Link': 'tblrec' , 'Description': 'records values to table (value stays on the stack).'},
...
'tenv': { 'Args': [ 'trig', 'attack', 'sustain', 'release' ], 'Outputs': 1 , 'Link': 'tenv' , 'Description': 'Triggerable linear envelope generator. Values in seconds.'},
...
'tget': { 'Args': [ 'index', 'table' ], 'Outputs': 1 , 'Link': 'tget' , 'Description': 'Get value from table'},
...
'tin': { 'Args': [ '(none)' ], 'Outputs': 1 , 'Description': 'Read trigger from STDIN.'},
...
'tri': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Link': 'bltriangle' , 'AliasOf': 'bltriangle' , 'Description': 'Band-limited triangle oscillator (alias of: bltriangle)'},
'triangle': { 'Args': [ 'freq (f)', 'amp (f)' ], 'Outputs': 1 , 'Link': 'bltriangle' , 'AliasOf': 'bltriangle' , 'Description': 'Band-limited triangle oscillator (alias of: bltriangle)'},
